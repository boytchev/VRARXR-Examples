 ...
 *
 * vaxInitVR()		инициализира VR режим и поддържа
 *					анимационен цикъл с animate()
 *
 ...
 *
 * vaxSceneInit(n)	инициализира и създава сцена със земя
 *					и n пилона
 *
...
function vaxInitVR( rendererOptions = {antialias:true} )
{
	vaxInit( rendererOptions );
