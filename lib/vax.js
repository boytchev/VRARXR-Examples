...
console.log( 'vax.js v1.13 ˁ˚ᴥ˚ˀ' )
...
function init( animateLoop, rendererOptions = {antialias:true} )
{
	animate = animateLoop;
...
function sceneInit(animateLoop, vax = init, vatInitParam = 0 )
{
	showStats = false;
...
export {
	init, sceneInit, Pillar, renderer, camera, scene, light, ground,
	object, ambientLight, spotLight, robotMaterial, robotElement, robotElementShape, orthogonal,
	initAnaglyph, initParallax, effect, initVR };