...
function init( animateLoop, rendererOptions = {antialias:true, stats:false, physijs:false} )
{
	...
	if( rendererOptions.physijs )
	{
		//Physijs.scripts.worker = 'physijs/physijs_worker.js';
		//Physijs.scripts.ammo = 'ammo.js';
		Physijs.scripts.worker = 'https://boytchev.github.io/CourseVAX/lib/physijs/physijs_worker.js';
		Physijs.scripts.ammo = 'ammo.js';
